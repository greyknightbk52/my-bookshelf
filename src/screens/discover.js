  ...
  return (
    <div>
      ...
      <div>
        {queried ? null : (
          <div
            css={{ marginTop: "20px", fontSize: "1.2em", textAlign: "center" }}
          >
            ...
            {isLoading ? (
              ...
              <p>Hmmm... I couldn't find any books to sugest for you. Sorry.</p>
            ) : null}
          </div>
        )}
        ...
        {books.length ? (
          ...
          <div css={{ marginTop: 20, fontSize: "1.2em", textAlign: "center" }}>
            {isLoading ? (
              ...
              <p>
                Hmmm. I couldnt find any books with the query "{query}." Please
                try another.
              </p>
            )}
          </div>
